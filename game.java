...
//      new Figure(Figure.L_FIGURE),
  ...
  private void handleStart() {
    ...
    score = 0;
    figure = null;
    nextFigure = randomFigure();//brick random
    nextFigure.rotateRandom();// rotate random
...
*/
  ...
  //force event to increase point,level,finish
  ...
  //force event keyboard for Button
  private synchronized void handleKeyEvent(KeyEvent e) {
    ...
    //move to left
    switch (e.getKeyCode()) {
      case KeyEvent.VK_LEFT:// force the event move to left
        figure.moveLeft();//event move to left
        break;
	//move to right
